...
Jupyter notebooks showing off how to
...
[![Binder](http://mybinder.org/badge.svg)](http://mybinder.org/repo/olaurino/sherpa-standalone-notebooks)
 ...
 - [A really simple "fit"](really%20simple%20fit.ipynb),
 ...
 - [A simple fit](simple%20sherpa%20fit.ipynb) which is based on
 ...
 - [Writing your own user model](user%20model.ipynb),
 ...
 - [An integrated user model](an%20integrated%20user%20model.ipynb),
 ...
 - [How can I plot data and models when using the lower-level routines](plotting%20using%20the%20lower-level%20routines.ipynb),
 ...
 - [Extending existing models (and an example of using XSPEC models)](extending%20existing%20models%20%28and%20XSPEC%29.ipynb),
 ...
 - [Simulating 2D data with a dash of error analysis](simulating%20a%202D%20image%20and%20a%20bit%20of%20error%20analysis.ipynb),
 ...
 - [Simulating and fitting a 2D image (this time with a Bayesian approach)](simulating%20and%20fitting%20a%202D%20image%20%28this%20time%20with%20a%20Bayesian%20approach%29.ipynb),
